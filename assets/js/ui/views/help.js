...
export function renderHelp(store) {
  ...
  root.appendChild(h('section', { class: 'card' },
    h('div', { class: 'help-section' },
      ...
      h('p', {}, 'メモを選ぶと、全画面の編集画面が開きます。画面の大部分が本文で、'
        + '操作は上のツールバー・下のショートカットバー・ステータスバーに寄せてあります。'),
      h('table', { class: 'help-table' },
        h('thead', {}, h('tr', {}, h('th', {}, '場所'), h('th', {}, 'できること'))),
        h('tbody', {},
          h('tr', {}, h('td', {}, 'ツールバー'), h('td', {}, '一覧へ戻る／タイトル／元に戻す・やり直す／検索／メモ情報／その他')),
          h('tr', {}, h('td', {}, 'ショートカットバー'), h('td', {}, 'リスト・チェック・完了・字下げ・日時の挿入')),
          h('tr', {}, h('td', {}, 'ステータスバー'), h('td', {}, '保存状態・文字数・行数（PC では行:桁も）')),
          h('tr', {}, h('td', {}, 'メモ情報'), h('td', {}, '手掛かり・タグ・復習の設定・復習の記録・記憶の枝')))),
      h('ul', {},
