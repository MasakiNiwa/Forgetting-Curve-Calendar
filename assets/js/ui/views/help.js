  ...
  root.appendChild(h('section', { class: 'card' },
    h('div', { class: 'help-section' },
      ...
      h('p', {}, '画面右上のリング（◎）から開きます。毎日 0:00 に、その日にできる小さなお題が'
        + '最大 3 つ出ます。カレンダーの上にも今日のお題が帯で出ます。'),
      h('table', { class: 'help-table' },
        h('thead', {}, h('tr', {}, h('th', {}, '枠'), h('th', {}, '出るお題の例'))),
        h('tbody', {},
          h('tr', {}, h('td', {}, '思い出す'), h('td', {}, '今日の復習を数件／やりきる／1ヶ月より前のメモに再会する')),
          h('tr', {}, h('td', {}, '書く'), h('td', {}, 'メモを 1 つ書く／200 文字書く／前のメモに書き足す')),
          h('tr', {}, h('td', {}, 'おまけ'), h('td', {}, '追加メモを生やす／先の月をのぞく／バックアップを保存する')))),
      h('ul', {},
