...
export function renderHelp(store) {
  ...
  root.appendChild(h('section', { class: 'card' },
    h('div', { class: 'help-section' },
      ...
      h('ul', {},
        h('li', {}, '入力画面は本文が主役です。タイトル・手掛かり・タグは、必要なときだけ「＋」で足せます。'),
        h('li', {}, '書きかけは入力するたびに自動保存されます。閉じても、次に開くと続きから書けます。'),
        h('li', {}, '保存が終わるまで画面は閉じません。失敗したときは本文を残したまま、再試行できます。'),
        h('li', {}, '復習の予定を決めたくないときは、復習の設定で「あとで決める」を選べます。'
          + 'あとから一覧の「復習を始める」でいつでも設定できます。'),
        h('li', {}, '一覧のカードから直接「編集」「追加メモ」に進めます。並び順の既定は「最近さわった順」です。')))));
  ...
  root.appendChild(h('section', { class: 'card' },
    h('div', { class: 'help-section' },
      ...
      faq('書きかけのメモは消えませんか？', '入力するたびに自動で下書きが保存されます。'
        + '閉じても次に開いたときに復元され、「破棄」を押したときだけ消えます。'
