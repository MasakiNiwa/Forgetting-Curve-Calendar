...
const PATHS = {
  ...
  /* 学びのとびら（外のサイトへのリンク集）。開いた扉と、その先の光 */
  portal: '<path d="M4 20.5V4.8a.8.8 0 0 1 .9-.8l7.6.9v15.6z"/><path d="M15 6.5h4.2a.8.8 0 0 1 .8.8v12.4a.8.8 0 0 1-.8.8H15"/><path d="M9.6 12.4h.01"/>',
  bookmark: '<path d="M6.5 3.8h11a.8.8 0 0 1 .8.8v15.6l-6.3-4.2-6.3 4.2V4.6a.8.8 0 0 1 .8-.8z"/>',
  ...
  heading: '<path d="M6 5v14M18 5v14M6 12h12"/><path d="M3.5 5h5M15.5 5h5M3.5 19h5M15.5 19h5"/>',
  omikuji: '<path d="M7.5 3.5h9l1.4 17h-11.8z"/><path d="M9.6 3.5v3.4h4.8V3.5"/><path d="M10 12h4M10 15.5h4"/>',
  /* ---- 本文を書くときの道具（ふつうのエディタに近い形にする） ---- */
  bold: '<path d="M7.5 5h5a3.4 3.4 0 0 1 0 6.8h-5z"/><path d="M7.5 11.8h5.6a3.6 3.6 0 0 1 0 7.2H7.5z"/>',
  italic: '<path d="M15.5 5h-5M13.5 19h-5M13.8 5l-3.6 14"/>',
  underline: '<path d="M7 4.5v7a5 5 0 0 0 10 0v-7"/><path d="M5.5 19.5h13"/>',
  strike: '<path d="M4 12h16"/><path d="M16 8.2c-.4-1.8-2-2.9-4.1-2.9-2.3 0-3.9 1.2-3.9 2.9 0 1.2.8 2 2.2 2.6M8 15.6c.3 2 2 3.1 4.2 3.1 2.3 0 3.8-1.1 3.8-2.8 0-.9-.4-1.6-1.2-2.1"/>',
  codeTag: '<path d="M9 7l-5 5 5 5M15 7l5 5-5 5"/>',
  link: '<path d="M10.2 13.8a3.9 3.9 0 0 0 5.6 0l2.4-2.4a3.9 3.9 0 1 0-5.6-5.6l-1.2 1.2"/><path d="M13.8 10.2a3.9 3.9 0 0 0-5.6 0l-2.4 2.4a3.9 3.9 0 1 0 5.6 5.6l1.2-1.2"/>',
  linkOff: '<path d="M4 4l16 16"/><path d="M10.6 13.4a3.9 3.9 0 0 0 5.2.3l2.4-2.4a3.9 3.9 0 0 0-5-5.9"/><path d="M13.2 10.4a3.9 3.9 0 0 0-5 .2l-2.4 2.4a3.9 3.9 0 0 0 5.3 5.7"/>',
  listNumber: '<path d="M10 6.5h10M10 12h10M10 17.5h10"/><path d="M3.6 5l1.5-.8v4.3M3.4 13.2a1.5 1.5 0 0 1 2.9.5c0 1.2-2.9 2.2-2.9 3.8h3"/>',
  quote: '<path d="M4.5 5.5v13"/><path d="M9 7.5h10.5M9 12h10.5M9 16.5h6.5"/>',
  table: '<rect x="3.5" y="4.5" width="17" height="15" rx="2"/><path d="M3.5 9.5h17M3.5 14.5h17M9.8 4.5v15M15.2 4.5v15"/>',
  rule: '<path d="M3.5 12h17"/><path d="M6.5 7h11M6.5 17h8"/>',
  lineBreak: '<path d="M20 6v5a2.6 2.6 0 0 1-2.6 2.6H5"/><path d="M8.6 10L5 13.6l3.6 3.6"/>',
  format: '<path d="M3.5 18.5l4.6-11.5 4.6 11.5M5.4 14.6h5.6"/><path d="M20.5 12v6.5M20.5 13.4a2.9 2.9 0 1 0 0 4"/>',
  rowAdd: '<rect x="3.5" y="4.5" width="17" height="6" rx="1.5"/><path d="M12 14v6.5M8.8 17.2h6.4"/>',
  rowRemove: '<rect x="3.5" y="4.5" width="17" height="6" rx="1.5"/><path d="M8.8 17.2h6.4"/>',
  columnAdd: '<rect x="4.5" y="3.5" width="6" height="17" rx="1.5"/><path d="M17.2 8.8v6.4M14 12h6.5"/>',
  columnRemove: '<rect x="4.5" y="3.5" width="6" height="17" rx="1.5"/><path d="M14 12h6.5"/>',
  tableRemove: '<rect x="3.5" y="4.5" width="12" height="12" rx="2"/><path d="M3.5 9.5h12M9.5 4.5v12"/><path d="M16.5 16.5l5 5M21.5 16.5l-5 5"/>',
