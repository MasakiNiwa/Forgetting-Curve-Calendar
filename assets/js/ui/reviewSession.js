    ...
    clear(body).append(
      h('div', { class: 'session__done' },
        ...
        h('div', { class: 'session__summary' },
          summaryItem(RATINGS.known.label, results.known, 'var(--fcc-success)'),
          summaryItem(RATINGS.vague.label, results.vague, 'var(--fcc-warning)'),
          summaryItem(RATINGS.forgot.label, results.forgot, 'var(--fcc-error)')),
